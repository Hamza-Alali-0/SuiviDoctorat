...
TRANSLATIONS.ar.cta = { badge: 'ابدأ اليوم', title: 'مستعد لتحويل رحلتك البحثية؟', subtitle: 'انضم إلى آلاف الباحثين الذين طوّروا تجربتهم الدكتورالية مع منصتنا.', getStarted: 'ابدأ مجاناً', signIn: 'تسجيل الدخول', progress: 'متوسط معدل الإنجاز', features: { free: 'خطة مجانية للأبد', secure: 'أمان مؤسسي', support: 'دعم 24/7' }, trust: 'موثوقة لدى جامعات حول العالم' };
